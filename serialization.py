...
class _SerializationLocal(threading.local):
    def __init__(self):
        super().__init__()
        self.map_location: Optional[MAP_LOCATION] = "CPU"
...
def load(
    ...
    **pickle_load_args: Any,
    ...
    """load(f, map_location='cpu', pickle_module=pickle, *, weights_only=True, mmap=None, **pickle_load_args)
...
def _load(
    ...
    **pickle_load_args,
    ...
    result = unpickler.load()
    _serialization_tls.map_location = 'cpu'
